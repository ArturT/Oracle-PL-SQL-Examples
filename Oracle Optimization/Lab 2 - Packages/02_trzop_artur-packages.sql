...
IS
	...
	--### Funkcja prze³adowana. Jako ostatni argument zamiast ID urzêdu pocztowego mo¿emy podaæ kod pocztowy i na jego podstawie zostanie
...
IS
	...
	-- +++<<<### START ###>>>+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	-- Procedura dodawania nowego urzêdu pocztowego	
	-- Nie bêdziemy sprawdzaæ czy podane miasto siê powtarza w tabeli poniewa¿ w danym mieœcie mo¿e byæ kilka urzêdów pocztowych
...
BEGIN
	...
	*/
	...
	--PACKAGE_OSO_ADR.P_NEW_ADRES_POCZTY('Nowy Jork', '12-3453', 'Niepodleg³oœci', '12/34');
	PACKAGE_OSO_ADR.P_NEW_ADRES_POCZTY('Now', '10-347', 'Niepodleg³oœci', '12/4');
	...
	-- wyœwietlenie danych o u¿ytkowniku z u¿yciem kursora
	PACKAGE_OSO_ADR.P_WYSWIETL_OSOBA(liczba);
	
	
	
	-- wywo³anie tej samej funkcji tylko z przeci¹¿onym argumentem
