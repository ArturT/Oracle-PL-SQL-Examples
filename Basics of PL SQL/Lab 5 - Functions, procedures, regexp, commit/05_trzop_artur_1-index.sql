...
-- nazwa IX_CSR_FK1_KOM_REC oznacza ze mamy klucz obcy FK1 w tabeli KOM... który odnosi się do tabeli REC...
-- indexy BITMAP nie działają w wersji darmowej bazy
...
--### Index unikatowy dla adresu email. Nie mogą się powtarzać emaile w bazie. 
-- Czyli na tej sam adres email nie może być zarejestrowane kilka kont.
...
-- Ksiazki beda wyszukiwane za pomocą takiego zapytania:
